SERVICE = integrate_probable_annotation
SERVICE_CAPS = integrate_probable_annotation
SPEC_FILE = integrate_probable_annotation.spec
URL = https://kbase.us/services/integrate_probable_annotation
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
