...
class integrate_probable_annotation(object):
    ...
    def integrate_annotation(self, workspace_name, genome_id, missing_role_data, outputGenome, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method integrate_annotation: argument json_rpc_context is not type dict as required.')
        resp = self._call('integrate_probable_annotation.integrate_annotation',
                          [workspace_name, genome_id, missing_role_data, outputGenome], json_rpc_context)
        return resp[0]
